        ...
        <div v-show="activeTab === 'shortcuts'" class="settings-tab">
          <div class="form-group">
            ...
            <div class="shortcut-list">
              ...
              <div class="shortcut-item">
                <span class="shortcut-name">SQL模版生成器</span>
                <input type="text" v-model="shortcuts.template" class="input-field shortcut-input" placeholder="快捷键">
              </div>
              <div class="shortcut-item">
...
const menuItems = [
  { id: 'general', icon: '⚙️', text: '通用' },
  { id: 'database', icon: '🗄️', text: '数据库' },
  { id: 'scripttype', icon: '📝', text: '脚本类型' },
  { id: 'shortcuts', icon: '⌨️', text: '快捷键' },
  { id: 'about', icon: 'ℹ️', text: '关于软件' },
]
...
async function save() {
  ...
  try {
    ...
    if (success) {
      ...
      await window.electronAPI.reloadMenu()
